            ...
            <div className="flex justify-center mt-[53px] bg-gradient-to-b from-[#275c5e] to-[#458d92]">
                <div className='w-full max-w-[1270px]'>
                    <div className="w-full">
                        <img src={dataWarehouse} alt="" className="w-full object-cover hidden md:block lg:block sm:block" />
                        <img src="https://blinkit.com/blog/sites/default/files/styles/banner_mobile/public/2024-07/mobile%20cover%20banner.png?itok=9lR6Qnt1" alt="" className='sm:hidden md:hidden lg:hidden h-170'/>
                    </div>
            ...
            <div className=' flex justify-center mt-4'>
                <div className=' max-w-[1250px] w-[80%] ' >
                    ...
                    <div className='my-10'>
                        ...
                        <p className='pb-4'>Legacy data pipeline build had quite a few daunting tasks in day-to-day work , which needed a solve for future scalability and quality outcomes</p>
                    ...
                    <div>
                        ...
                        <p>dbt (data build tool) is a workflow ecosystem that helps build transformational data pipelines with high speed and trustworthy reliability. It makes things pretty simple in abstracting connection management, threading and multiple other aspects needed to build future-ready data pipelines</p>
